...
public class XzEntityScannerRegistrar implements ImportBeanDefinitionRegistrar {

    private final Environment environment;

    XzEntityScannerRegistrar(Environment environment) {
    ...
    private Set<String> getPackagesToScan(AnnotationMetadata metadata) {
        AnnotationAttributes attributes = AnnotationAttributes
                .fromMap(metadata.getAnnotationAttributes(XzEntityScan.class.getName()));
