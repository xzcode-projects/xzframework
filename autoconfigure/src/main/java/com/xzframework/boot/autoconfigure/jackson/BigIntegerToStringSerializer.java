...
public class BigIntegerToStringSerializer extends JsonSerializer<BigInteger> {
    ...
    private static final BigInteger MAX_SAFE_INTEGER = new BigInteger("9000000000000000L");
    //    private static final Long MIN_SAFE_INTEGER = -9007199254740991L;
    private static final BigInteger MIN_SAFE_INTEGER = new BigInteger("-9000000000000000L");
